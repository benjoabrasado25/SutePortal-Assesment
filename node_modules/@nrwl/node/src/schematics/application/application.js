...
function updateWorkspaceJson(options) {
    return workspace_1.updateWorkspaceInTree((workspaceJson) => {
        ...
        project.architect.lint = workspace_1.generateProjectLint(core_1.normalize(project.root), core_1.join(core_1.normalize(project.root), 'tsconfig.app.json'), options.linter, [`${options.appProjectRoot}/**/*.ts`]);
